...
class TriplaneTransformer(nn.Module):
    ...
    def __init__(self, inner_dim: int, image_feat_dim: int, camera_embed_dim: int,
        ...
        print(f"self.pos_embed: {self.pos_embed}")
        print("going to self.layers")
    ...
    def forward(self, image_feats, camera_embeddings):
        ...
        print("In the forward pass of TriplaneTransformer")
        ...
        print("Forward pass of TriplaneTransformer done")
        return x
